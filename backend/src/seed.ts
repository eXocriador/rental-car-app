...
const carsData = [
  ...
  },
  {
    ...
    rentalConditions:
      "Minimum 1 day rental, performance driving experience required",
    mileage: 12000
  },
  {
    year: 2021,
    ...
    description:
      "Legendary sports car with precision engineering and performance",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Luxury SUV with hybrid technology and exceptional reliability",
...
const seedDatabase = async () => {
  try {
    ...
    cars.slice(0, 3).forEach((car) => {
      console.log(
        `- ${car.year} ${car.brand} ${car.carModel} ($${car.rentalPrice}/day)`
      );
    });
  } catch (error) {
